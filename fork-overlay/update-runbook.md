...
| 2026-09-05 | v1.23.0-beta.2 → v1.25.0-beta.1 (331 commits) | `d79441d0` | `codex-lb:main-d79441d02fcc` | 9 conflicts; `fix-targeted-oauth-reauth` layer absorbed upstream (dropped, OpenSpec change removed); `fork-overlay` added to new `[root_files]` allowlist; upstream deleted `DECISIONS.md`/`SUMMARY.md`. |
